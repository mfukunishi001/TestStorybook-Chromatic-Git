				...
				<div style="width:100%; overflow-y:hidden; overflow-x: auto;">
					<div style="min-width:1600px;">
						...
						<v-sheet class="_border bg-white elevation-2">
							<!-- ステッパー行 -->
							<div no-gutters class="_border">
								<div cols="12" class="_border">
						...
						<v-sheet class="_border bg-white mt-3 elevation-2">
							<!-- サブタイトル行 -->
							<div no-gutters class="_border">
								<div cols="12" class="_border _px-2">
									<!-- サブタイトル -->
						...
						<v-sheet class="_border bg-white mt-1 px-3 py-2 elevation-2">
							<div v-for="grid_list in grid_lists" no-gutters class="_border _py-2 d-flex">
								<div v-for="list in grid_list.lists" :cols="list.cols" class="_border _px-2">
									<v-sheet class="_border py-2 px-2" :width="list.width">
											...
											<template v-if="list.icon">
												...
												<v-dialog v-model="searchDialog" persistent width="500px">
													<v-card>
														...
														<v-card-text>
															<div no-gutters class="_border py-2">
															...
															<div no-gutters class="_border py-2">
																<div cols="12" class="_border px-2 d-flex">
							...
							<!-- ボタン行 -->
							<div no-gutters class="_border _py-4">
								<div cols="12" class="_border _px-2">
