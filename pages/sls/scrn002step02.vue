...
const stepper_lists = ref<Stepper[]>([
	...
	{ icon: 'mdi-numeric-2-circle-outline', label: '担当者情報', hr: false, active: true, },
	{ icon: '', label: '', hr: true, active: false, },
	...
	<v-main>
		<v-container class="bg-blue-lighten-5">
			<v-container class="bg-white">
				...
				<v-row dense>
					<v-col cols="4">
						<v-btn class="ma-2" color="primary" to="/sls/scrn002step01">戻る</v-btn>
						<v-btn class="ma-2" color="primary" to="/sls/scrn002step03">次へ</v-btn>
					</v-col>
				</v-row>
